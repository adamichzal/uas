...
<?= form_open(base_url('admin/kategori_galeri'));
echo csrf_field();
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="nama_kategori_galeri" class="form-control" placeholder="Category Name" value="<?= set_value('nama_kategori_galeri') ?>" required>
					</div>
				</div>
